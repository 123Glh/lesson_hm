<template>
  ...
  <div class="home">
    <!-- 背景 -->
    <div
      class="top-bg absolute h-[40rem] w-full -z-10 w-screen 
      bg-[url('https://pic4.zhimg.com/v2-719eceddb4a92fac8f4b9aea488f3d1d_r.jpg')] 
      bg-cover bg-center"
    ></div>
    <!-- 搜索+头部 -->
    ...
    <main class="flex flex-col space-y-4">
      ...
      <section>
        <div class="flex justify-between items-center px-6 text-sm text-white">
          <h2 class="title font-bold text-lg">热门球场</h2>
          <span
