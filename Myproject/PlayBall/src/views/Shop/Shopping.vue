<template>
  <div class="shopping ">
    <div class="fixed top-0 left-0 w-full h-[50rem] -z-10 transform -translate-y-0 bg-cover bg-center overflow-hidden"
     style="background-image: url('https://www.2008php.com/2019_Website_appreciate/2019-08-27/20190827202931ainEsLUWRFaM.jpg');">
</div>
    <header
